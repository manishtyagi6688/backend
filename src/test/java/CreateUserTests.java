...
public class CreateUserTests {
    ...
    @Test
    public void B_Users_CreateUser_InvalidEmailFormat_Failure() {
        final String invalidEmail = "invalidEmailFormat";
        final CreateUserModel createUserModel = new CreateUserModel("John Doe", invalidEmail, "Male", "Active");

        Response response = GoRestService.createUser(createUserModel);

        response.then()
                .statusCode(SC_UNPROCESSABLE_ENTITY) // Expecting 422 Unprocessable Entity
                .body("data", notNullValue())
                .body("data[0].message", equalTo("is invalid")); // Error message should indicate invalid email
    }
...
//    }
    ...
    @Test
    public void D_Users_UpdateUser_Success() {
...
//    @Test
//    public void E_Users_DeleteUser_Success() {
